...
cd "/Users/y_ushioda/Dropbox/RA/canada_insurance"

// make sure you put a copy of the first data here
// use this data as master file

insheet using "copy200001.csv", names
...
cd "/Users/y_ushioda/Dropbox/RA/canada_insurance/raw_data"

save master, replace

// create file list from which to collect data to combine

local csvfiles: dir "/Users/y_ushioda/Dropbox/RA/canada_insurance/raw_data" files "*.csv"
